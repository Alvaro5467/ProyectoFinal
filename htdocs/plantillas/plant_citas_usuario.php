  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
       ...
       <p class="card-text"> <img src="cita.jpg" style="width:400px; heigth:400px;"></p>
       
        <a href="listadoCitas" class="btn btn-primary btn-lg">Pedir Cita</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title"></h5>
        <p class="card-text"> <img src="cita2.jpg" style="width:400px; heigth:400px;"></p>
        <a href="cancelarCita" class="btn btn-danger btn-lg">Cancelar Cita</a>
      </div>
    </div>
  </div>
</div>
